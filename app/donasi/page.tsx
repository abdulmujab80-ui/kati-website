...
export default function DonasiPage() {
  ...
  const daftarPaket: PaketDonasi[] = [
    {
      ...
      alokasi: "Konservasi Hutan Mikro",
      ikon: ""
    },
    {
      id: "paket-edukasi",
      ...
      nominal: "Rp 150.000",
      deskripsi: "Menyediakan 1 paket buku panduan ekologi alam dan alat peraga eksperimen sains untuk anak-anak desa sidodadi.",
      alokasi: "Edukasi Anak & Masyarakat",
      ikon: ""
    },
    {
      id: "paket-tirta",
      ...
      alokasi: "Penyelamatan Sumber Air",
      ikon: ""
    }
  ];
  ...
  const rekeningDonasi = [
    { bank: "Bank Mandiri", nomor: "142-000-xxxx-xxxx", atasNama: "Kampus Alam Tegalsari Indonesia" },
    { bank: "Bank BRI", nomor: "0023-01-xxxxxx-xx-x", atasNama: "Kampus Alam Tegalsari Indonesia" },
  ...
  return (
    <main style={{ backgroundColor: '#f8fafc', minHeight: '100vh', padding: '60px 20px', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto 60px auto', display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <div style={{ flex: '1 1 200px', backgroundColor: 'white', padding: '30px', borderRadius: '20px', textAlign: 'center', border: '1px solid #e2e8f0', boxShadow: '0 4px 15px rgba(0,0,0,0.02)' }}>
          <div style={{ fontSize: '32px', fontWeight: '800', color: '#10b981', marginBottom: '5px' }}>100%</div>
          <div style={{ fontSize: '13px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase' }}>tranparansi dana</div>
        </div>
        <div style={{ flex: '1 1 200px', backgroundColor: 'white', padding: '30px', borderRadius: '20px', textAlign: 'center', border: '1px solid #e2e8f0', boxShadow: '0 4px 15px rgba(0,0,0,0.02)' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto 60px auto', backgroundColor: '#064e3b', borderRadius: '24px', padding: '40px', color: 'white', boxShadow: '0 15px 30px rgba(6, 78, 59, 0.15)' }}>
        <h2 style={{ fontSize: '24px', fontWeight: '700', marginBottom: '10px', textAlign: 'center' }}>
          Informasi Rekening Resmi Kampus Alam Tegalsari Indonesia
        </h2>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto 80px auto' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '40px' }}>
          <a href="https://wa.me/6281336867676" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto', padding: '30px', backgroundColor: '#f1f5f9', borderRadius: '20px' }}>
        <h4 style={{ color: '#0f172a', margin: '0 0 10px 0', fontSize: '16px', fontWeight: '700' }}>Ingin Berdonasi dalam Bentuk Fisik?</h4>
        <p style={{ color: '#475569', fontSize: '14px', lineHeight: '1.5', margin: 0 }}>
          Kami menerima kiriman donasi fisik bisa dikirim melalui paket atau langsung ke alamat sekretariat Kampus Alam Tegalsari Indonesia. Silakan hubungi kontak admin untuk koordinasi pengiriman paket kargo Anda.
        </p>
      </div>
