...
interface AnimasiProps {
  ...
  delay?: string;
  // 💡 Menambahkan properti style opsional agar layouting luar bisa diwariskan ke dalam animasi
  ...
  return (
    <div
      ...
      style={{
        ...
        // 💡 Menggunakan fallback dinamis agar tidak merusak susunan flexbox/grid global
...
export default function Home() {
  ...
  return (
    <main style={{ ...fontStyle, backgroundColor: "#ffffff", minHeight: "100vh", color: "#0f172a", overflowX: "hidden" }}>
      ...
      {/* 🟢 STYLE INJEKSI UNTUK EFEK SENTUH & HOVER PREMIUM */}
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            .kartu-berita { background: white; border-radius: 24px; border: 1px solid #e2e8f0; overflow: hidden; display: flex; flex-direction: column; transition: all 0.4s cubic-bezier(0.16, 1, 0.3, 1); }
            .kartu-berita:hover { transform: translateY(-6px); box-shadow: 0 30px 50px rgba(0,0,0,0.05); border-color: #10b981; }

            .kartu-artikel { background: white; border-radius: 20px; border: 1px solid #e2e8f0; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1); }
      ...
      {/* 🛠️ BAGIAN 4: Tentang Kami - Nilai Inti (SUDAH DIPERBAIKI CENTRALIZED) */}
      ...
      {/* 🛠️ BAGIAN 5: Dampak Nyata Berbasis Akuntabilitas (SUDAH DIPERBAIKI CENTRALIZED) */}
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '30px', width: '100%' }}>
            {[
              ...
              { angka: "18+", label: "Mitra Korporasi & LSM", sub: "Sinergi aksi serta dana riset iklim" },
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "25px", flex: "1" }}>
              {daftarBerita.map((item, index) => (
                <ElemenAnimasiScroll key={index} delay={`${index * 150}ms`}>
                  <div className="kartu-berita" style={{ flexDirection: "row", flexWrap: "wrap", width: "100%" }}>
                    ...
                    <div style={{ flex: "1.4 1 260px", padding: "30px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                      ...
                      <a href="#" style={{ color: "#064e3b", textDecoration: "none", fontWeight: "700", fontSize: "13.5px", marginTop: "20px", display: "inline-block", width: "fit-content" }}>Baca Selengkapnya</a>
                    </div>
                  </div>
                </ElemenAnimasiScroll>
              ))}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", flex: "1" }}>
              {daftarArtikel.map((art, index) => (
                <ElemenAnimasiScroll key={index} delay={`${index * 120}ms`}>
                  <div className="kartu-artikel" style={{ width: "100%" }}>
                    <div>
